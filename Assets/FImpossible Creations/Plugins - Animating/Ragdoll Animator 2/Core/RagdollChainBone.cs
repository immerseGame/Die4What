    ...
    public class RagdollChainBone
    {
        ...
        public class ColliderSetup
        {
            ...
            public Collider RefreshCollider( RagdollChainBone bone, bool fallMode, int colliderIndex, RagdollBonesChain chain, bool onSource )
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if( subTransform ) GameObject.Destroy( subTransform.gameObject );
                    }
                }
                ...
                else if( ColliderType == EColliderType.Mesh )
                {
                    ...
                    subTransform.localScale = ScaleUsingThickness( subTransform.localScale * scaleMul, thickness, chain, bone );
            ...
            private void DisposeWrongCollider( System.Type targetType )
            {
                ...
                {
                    if( GameCollider is MeshCollider ) GameObject.Destroy( GameCollider.gameObject );
                    else GameObject.Destroy( GameCollider );
                }
            }
            ...
            {
                if( GameCollider ) GameObject.Destroy( GameCollider );
                if( ColliderExtraTransform ) GameObject.Destroy( ColliderExtraTransform );
            }
        ...
        public class InBetweenBone
        {
            ...
            {
                if( FixedJoint ) GameObject.Destroy( FixedJoint );
